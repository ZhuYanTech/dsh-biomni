/**
 * Browser-trust fence for the /biomni routes, behaviorally identical to the
 ...
 * here because the package does not export these helpers and a plugin must not
 * depend on its internals). Host-header loopback or a configured trusted
 ...
 * @returns true when the request authority is loopback or explicitly trusted.
 */
export function isTrustedApiRequest(
  ...
  // No Host header: not a browser navigation this fence is meant to judge, and
