...
export const zh = {
  ...
  probing: '检测中…',
  probeFailed: '无法检测解释器',
  neverProbed: '尚未检测。检测会用当前解释器启动一个一次性进程，静态扫描 Biomni 工具库的两道依赖门。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  neverProbed: 'Not probed yet. Probing starts a throwaway process with the current interpreter and statically checks both of Biomni\'s dependency gates.',
